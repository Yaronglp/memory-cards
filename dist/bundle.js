...
var Basic = function (_React$Component) {
    ...
    function Basic(props) {
        ...
        _this.titleTxt = _this.props.title;
        _this.negBtnFN = _this.negBtnFN.bind(_this);
        _this.posBtnFN = _this.posBtnFN.bind(_this);
        return _this;
    }

    _createClass(Basic, [{
        key: "posBtn",
        value: function posBtn(txt, clkFN) {
            return _react2.default.createElement(
                "button",
                { className: "btn inst_btn",
        ...
        key: "negBtn",
        value: function negBtn(txt, clkFN) {
            return _react2.default.createElement(
                "button",
                { className: "btn inst_btn cancel_btn",
        ...
        key: "posBtnFN",
        value: function posBtnFN() {
            this.props.okFN();
        }
    }, {
        key: "negBtnFN",
        value: function negBtnFN() {
            this.props.cancelFN();
        }
    }, {
        key: "render",
        value: function render() {
            var modalClass = this.props.modalClass;

            var modalCls = "modal ";

            if (this.props.modalClass) modalCls += modalClass;
...
_reactDom2.default.render(_react2.default.createElement(_App2.default, null), document.getElementById('main_container'));
...
var _PlayGame = __webpack_require__(30);

var _PlayGame2 = _interopRequireDefault(_PlayGame);

var _AddPics = __webpack_require__(33);

var _AddPics2 = _interopRequireDefault(_AddPics);
...
var _Choice = __webpack_require__(39);
...
var App = function (_React$Component) {
    ...
    function App() {
        ...
        _this.addNewPics = _this.addNewPics.bind(_this);
        _this.openPicsModal = _this.openPicsModal.bind(_this);
        _this.exitPicsModal = _this.exitPicsModal.bind(_this);
    ...
    _createClass(App, [{
        ...
        key: 'openPicsModal',
        value: function openPicsModal() {
            this.setState({
                openPicsModal: true
            });
        }
    }, {
        key: 'rebuildCardsData',
        value: function rebuildCardsData(arr) {
            var tmpArr = JSON.parse(JSON.stringify(_data2.default)).cards;
        ...
        key: 'addNewPics',
        value: function addNewPics(imgArr) {
            var _this2 = this;

            (0, _Util.addImgResources)(imgArr).then(function (res) {
                _this2.rebuildCardsData(res);
            }).catch(function (err) {
                console.error(err);
        ...
        value: function render() {
            var _state = this.state,
                ...
                openPicsModal = _state.openPicsModal;


            return startGame === true ? _react2.default.createElement(_PlayGame2.default, { cards: cards,
                exitFN: this.exitGame }) : openPicsModal === false ? _react2.default.createElement(_Choice2.default, { title: _data2.default.openScreen.title,
                btn1Title: _data2.default.openScreen.btn1,
                btn1FN: this.startGame,
                btn2Title: _data2.default.openScreen.btn2,
                btn2FN: this.openPicsModal }) : _react2.default.createElement(_AddPics2.default, { title: _data2.default.addPicture.title,
...
var _Msg = __webpack_require__(32);
...
var PlayGame = function (_React$Component) {
    ...
    function PlayGame() {
        ...
        var _this = _possibleConstructorReturn(this, (PlayGame.__proto__ || Object.getPrototypeOf(PlayGame)).call(this));
    ...
    _createClass(PlayGame, [{
        ...
        value: function componentDidUpdate() {
            var _state = this.state,
                peekedCards = _state.peekedCards,
                matchedCards = _state.matchedCards,
                finishGame = _state.finishGame;
            var cards = this.props.cards;


            if (peekedCards === 2) this.compareTwoCards();
        ...
        value: function compareTwoCards() {
            ...
            var _state2 = this.state,
                cardA = _state2.cardA,
                cardB = _state2.cardB,
                matchedCards = _state2.matchedCards;
        ...
        key: 'isPermittedToPeek',
        value: function isPermittedToPeek() {
            return this.rtPeekedCards < 2;
        }
    }, {
        key: 'peekCard',
        value: function peekCard(card) {
            var peekedCards = this.state.peekedCards;
        ...
        key: 'flipDiffCards',
        value: function flipDiffCards(a, b) {
            this.rtPeekedCards = 0;
            a.click();
            b.click();
        }
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    cards.map(function (item, idx) {
                        return _react2.default.createElement(_Card2.default, { key: idx,
                            val: item.value,
                            alt: item.alt,
                            pic: item.pic,
...
var Card = function (_React$Component) {
    ...
    function Card(props) {
        ...
        _this.cardMatched = _this.cardMatched.bind(_this);
        return _this;
    }
    ...
    _createClass(Card, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'div',
                    { className: 'flip_card', onClick: !this.state.isMatched ? this.flipCard : null },
                    _react2.default.createElement('div', { className: 'front_card' }),
                    _react2.default.createElement(
                        'div',
                        { className: 'back_card' },
                        _react2.default.createElement('img', { className: 'img_card',
                            src: pic,
                            alt: alt,
                            'data-val': value })
                    )
...
var _Basic2 = __webpack_require__(14);
...
var Msg = function (_Basic) {
    _inherits(Msg, _Basic);
...
var AddPics = function (_Basic) {
    _inherits(AddPics, _Basic);

    function AddPics(props) {
        _classCallCheck(this, AddPics);

        var _this = _possibleConstructorReturn(this, (AddPics.__proto__ || Object.getPrototypeOf(AddPics)).call(this, props));

        _this.numOfInputs = 9;
        _this.onInputChange = _this.onInputChange.bind(_this);
        _this.onSubmitBtn = _this.onSubmitBtn.bind(_this);
        return _this;
    }

    _createClass(AddPics, [{
        key: 'picsUrlInputs',
        value: function picsUrlInputs() {
            var _this2 = this;

            var arr = [];

            for (var i = 0; i < this.numOfInputs; ++i) {
                arr.push(React.createElement('input', { key: i,
                    'data-idx': i,
        ...
        value: function onInputChange(e) {
            ...
            this.setState(_defineProperty({}, 'input' + ele.getAttribute('data-idx'), ele.value));
        }
    }, {
        key: 'onSubmitBtn',
        value: function onSubmitBtn() {
            var arr = [];
            var obj = this.state;
...
var sortArrRandomly = function sortArrRandomly(arr) {
...
var duplicateArr = function duplicateArr(arr) {
    return arr.concat(arr);
};

var addImgResources = function addImgResources(urls, timeout) {
    var promises = [];
...
var addResourceIfValid = function addResourceIfValid(url, timeout) {
...
var Choice = function Choice(_ref) {
    var title = _ref.title,
        btn1Title = _ref.btn1Title,
        btn1FN = _ref.btn1FN,
        btn2Title = _ref.btn2Title,
        btn2FN = _ref.btn2FN;

    return React.createElement(
        "div",
        { className: "open_screen" },
        React.createElement(
            "h1",
            { className: "truncate" },
            title
        ...
        React.createElement(
            "button",
            { className: "btn inst_btn truncate",
                onClick: btn1FN },
            btn1Title
        ),
        React.createElement(
